package easyphoto.easyphoto.VoiceRecognition;
...
import easyphoto.easyphoto.FaceTrackerActivity;
...
public class SpeechRecognizerManager {
    ...
    private FaceTrackerActivity mFaceTrackerActivity;
    ...
    protected class SpeechRecognitionListener implements RecognitionListener
    {
        ...
        public synchronized void onError(int error) {
            //if (!mFaceTrackerActivity.deneme) {
            ...
            if(preferences.getBoolean("trick",true))
            {
                editor.putBoolean("trick", false);
